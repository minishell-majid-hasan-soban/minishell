...
/*   Updated: 2024/02/11 21:46:52 by amajid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_token_arr	tokenize(char *prompt)
{
	...
	if (tokens.arr[tokens.count - 1].type == TOKEN_AND
		|| tokens.arr[tokens.count - 1].type == TOKEN_OR
		|| tokens.arr[tokens.count - 1].type == TOKEN_PIPE)
	{
